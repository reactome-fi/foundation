...
public class BreadthFirstSearch {
    ...
    /**
     * Calculate average minimum distance between two sets of nodes. This method
     * should be used to calculate distances between two samples or two cancer types
     * having a set of features connected by edges (e.g. mutated genes). 
     * @param set1
     * @param set2
     * @param bfs
     * @param idToPartners
    ...
    public double calculateMinShortestPath(Set<String> set1,
        ...
        for (String gene1 : list1) {
            ...
            for (Integer tmp : geneToDistance.values()) {
                if (tmp < shortest)
                    shortest = tmp;
            }
            total += shortest;
    ...
    /**
     * Calculate the average distance between two sets of nodes.
     * @param set1
     * @param set2
     * @param idToPartners
     * @return
